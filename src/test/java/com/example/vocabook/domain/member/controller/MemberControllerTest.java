...
class MemberControllerTest {
    ...
    void getMyProfile_Success() throws Exception {
        // given
        MemberResDTO.MyProfile response = new MemberResDTO.MyProfile("Tester", "test@example.com", 0L, 0L, 0L, Authorize.ROLE_USER, java.util.Collections.emptyList());
    ...
    void getFriendProfile_Success() throws Exception {
        // given
        Long friendId = 2L;
        MemberResDTO.FriendProfile response = new MemberResDTO.FriendProfile(2L, "Friend", 0, 0L, 0L, 0L, LocalDateTime.now());
    ...
    void updateProfile_Success() throws Exception {
        // given
        MemberReqDTO.UpdateProfile request = new MemberReqDTO.UpdateProfile("UpdatedNickname", "updated@example.com", java.util.Collections.emptyList(), "password123");
    ...
    void updateProfile_NoPassword_BadRequest() throws Exception {
        // given
        MemberReqDTO.UpdateProfile request = new MemberReqDTO.UpdateProfile("UpdatedNickname", "updated@example.com", java.util.Collections.emptyList(), null);
